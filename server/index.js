...
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    const emailContent = {
      to: config.CONTACT_EMAIL || 'hello@vueland.com',
      from: config.FROM_EMAIL || 'noreply@vueland.com',
      replyTo: email,
...
app.listen(PORT, () => {
  ...
  console.log(`📧 SendGrid configured: ${config.SENDGRID_API_KEY ? 'Yes' : 'No'}`);
  console.log(`📬 Contact email: ${config.CONTACT_EMAIL || 'hello@vueland.com'}`);
});
